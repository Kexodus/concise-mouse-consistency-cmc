...
The plugin also restores full-rate first-person horizontal look while actively sprinting or aiming a bow. During bow aim and Eagle Eye zoom, horizontal and vertical mouse response stay freelook-equivalent. CMC only corrects Skyrim's measured half-rate yaw frames, leaving normal look and full-rate transitions unchanged.
