...
namespace
{
    ...
    void LogBuildIdentity()
    {
        ...
        std::string message =
            ...
            " eagleEyeFovBoth=0 axisParity=1 eagleEyeYawTimeComp=1 timeMultCurrent=1 timeCompAgreeGate=1 timeCompWallRewrite=1 pitchPauseOnYawSkip=1 orphanHalfRate=1 freelookYawEmaGuard=1 castingTelemetry=1 cameraPersonExact=1 bstimerRealtimeOffset=1 addressLibV5=1 finalPitchNormalize=3 thirdPersonPitchNormalize=0 bowAimMouseFirstPersonOnly=1 finalPitchTelemetry=1 telemetryVerboseGated=1 renderedFovDiag=1";
